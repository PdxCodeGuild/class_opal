...
POSTS = [
    {
        'id': '1',
        'title': "A look at Members of Delight Infinite (This title leads somewhere! Click on me!)",
        'author': "hyeongjun",
        'icon': '/static/rockee.png',
        'date': "Today at 4:20 pm",
        'body': ["Hover over this article on desktop for a cool effect!",
        "Un ensemble comprenant un adaptateur peut être utilisé pour raccorder des conducteurs cardiaques implantés à un dispositif d'essai.",
